...
object AboutGuideMapDestination: NavigationDestination {
    override val route = "Guide_map_about"
    override val titleRes = R.string.guide_map
}
...
fun GuideMapAbout(
    ...
    Scaffold(
        ...
        topBar = {
            AboutPageTopAppBar(
                title = stringResource(R.string.guide_map),
        ...
        GuideMapAboutBody(innerPadding)
    }
}

@Composable
fun GuideMapAboutBody(
                ...
                Box(
                    ...
                    Column(
                        ...
                        Row(
                            ...
                            TitleTextAndIcon(
                                url = R.drawable.map_with_location,
                                description = "About The Map"
                            )
                        }
                        Text(
                            textAlign = TextAlign.Justify,
                            text = "• The Map Screen allows users to manually select a starting location and destination to calculate a route.\n" +
                                   "• If location services are enabled, the app will automatically set your current location as the starting point, replacing the previously selected location."
                        )
                    }
                }
            }
